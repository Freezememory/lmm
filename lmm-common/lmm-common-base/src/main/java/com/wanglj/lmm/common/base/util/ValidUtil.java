...
public class ValidUtil {
    ...
    public static void main(String[] args) {
        ...
        String str2 = "";
        String str3 = "test";
        System.out.println(isNotNull(integer));
        System.out.println(isNotNull(str));
        System.out.println(isNotNull(str2));
        System.out.println(isNotNull(str3));
    }
     ...
     * @throws ValidateException 检查不满足条件抛出的异常
     */
    public static String validateIsBlank(String value, String errorMsgTemplate, Object... params) throws ValidateException {
     ...
     * @throws ValidateException 检查不满足条件抛出的异常
     */
    public static String validateNotBlank(String value, String errorMsgTemplate, Object... params) throws ValidateException {
    ...
    public static <T> T validateNotEmpty(T value, String errorMsg) throws ValidateException {
        if (value instanceof Iterable && CollUtil.isEmpty((Iterable<?>) value)) {
            throw new ValidateException(errorMsg);
        }
        if (isEmpty(value)) {
            throw new ValidateException(errorMsg);
    ...
    public static boolean isBirthday(int year, int month, int day) {
        ...
        if (month == 2) {
            return day <= 29 && (day != 29 || false != DateUtil.isLeapYear(year));
        }
        return true;
    }
